...
namespace ecommerce_apple_phone.Models {
    public class ProductModel : IProductModel {
        ...
        public ProductAttrDTO AddAttrDTOs (int attrId, ProductAttrDTO productAttrDTO) {
        ...
        public ProductAttrDTO GetAttrDTO (int attrId) {
            throw new System.NotImplementedException ();
        }
        ...
        public List<ProductAttrDTO> GetListAttrDTOs (int productId) {
            throw new System.NotImplementedException ();
        }
        ...
        public bool UpdateAttrDTO (int attrId, ProductAttrDTO productAttrDTO) {
            throw new System.NotImplementedException ();
        }
